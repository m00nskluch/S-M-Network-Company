  ...
  const content = (
    <span className="relative inline-block overflow-hidden h-5">
      <span className="block transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:-translate-y-full">
        <span className="h-5 flex items-center justify-center whitespace-nowrap">{children}</span>
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] selection:bg-emerald-100 selection:text-emerald-950 overflow-x-hidden antialiased font-sans p-4 md:p-6 lg:p-10 pt-24 relative">
      ...
      {/* Living Ambient Background (Orbs Canvas) */}
      <div className="fixed inset-0 overflow-hidden -z-10 pointer-events-none">
        <motion.div 
          ...
          className="absolute top-10 left-1/4 w-[500px] h-[500px] bg-gradient-to-r from-emerald-500/20 via-cyan-500/10 to-slate-900/10 rounded-full blur-[110px]" 
        />
        <motion.div 
          animate={{
            x: [0, -110, 70, 0],
          ...
          className="absolute top-1/3 right-1/4 w-[550px] h-[550px] bg-gradient-to-r from-cyan-500/20 via-emerald-500/10 to-slate-900/10 rounded-full blur-[120px]" 
        />
      </div>

      {/* HEADER: Floating Glass Pill Navbar */}
      <nav className="fixed top-4 left-4 right-4 max-w-7xl mx-auto bg-slate-900/80 backdrop-blur-md rounded-full border border-slate-800 shadow-2xl px-4 md:px-8 py-3 flex items-center justify-between z-50 transition-all duration-300">
        ...
        {/* Right: Live Santiago Clock & CTA Button */}
        <div className="flex items-center gap-4">
          <div className="hidden lg:flex items-center gap-2 bg-slate-800/80 border border-slate-700/60 px-3.5 py-1.5 rounded-full text-[10px] font-black text-slate-200 shadow-inner">
          ...
          <TextRollButton
            href="#contacto"
            className="inline-flex items-center justify-center px-5 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest text-white bg-[#10B981] hover:bg-emerald-600 active:scale-[0.98] transition-all shadow-md shadow-emerald-500/20 border border-emerald-500/30"
          >
            Contacto Directo
          </TextRollButton>
        </div>
      ...
      <div className="max-w-7xl mx-auto border border-slate-200/80 dark:border-slate-800 rounded-3xl bg-white/70 backdrop-blur-xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] p-4 md:p-8 lg:p-10 space-y-16 relative overflow-hidden">
        
        {/* Fine gridlines overlay */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-[size:5rem_5rem] opacity-[0.12] pointer-events-none" />

        {/* HERO SECTION: Asymmetric Interactive Showcase */}
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10 pt-4">
          ...
          <motion.div 
            ...
            whileHover={{ y: -6 }}
            className="lg:col-span-7 bg-[#FFFFFF] border border-slate-200/80 rounded-3xl p-8 lg:p-12 flex flex-col justify-between shadow-sm relative overflow-hidden group hover:border-emerald-500/40 hover:shadow-lg hover:shadow-emerald-500/5 transition-all duration-300"
          >
            <div className="space-y-6 relative z-10">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-slate-100 text-slate-600 border border-slate-200 backdrop-blur-md">
                  SANTIAGO, CL
                </span>
              </div>
            ...
            <div className="pt-8 relative z-10 flex flex-col sm:flex-row gap-4 items-center">
              ...
              <TextRollButton
                href="#servicios"
                className="w-full sm:w-auto inline-flex items-center justify-center px-6 py-4 rounded-2xl text-xs font-extrabold uppercase tracking-widest text-slate-600 hover:text-slate-900 transition-all"
              >
                Conocer Soluciones
              </TextRollButton>
            </div>
          ...
          {/* Right Column: Phone/Device Mockup Preview */}
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ ...springTransition, delay: 0.1 }}
            whileHover={{ y: -6 }}
            className="lg:col-span-5 bg-[#FFFFFF] border border-slate-200/80 rounded-3xl p-6 lg:p-8 flex flex-col justify-center items-center shadow-sm relative overflow-hidden group hover:border-cyan-500/40 hover:shadow-lg hover:shadow-cyan-500/5 transition-all duration-300"
          >
            <div className="w-full max-w-[310px] bg-slate-950 rounded-[40px] border-4 border-slate-900 shadow-2xl overflow-hidden relative ring-8 ring-slate-100/60">
                ...
                <AnimatePresence>
                  {isCheckoutOpen && (
                    <motion.div 
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: 20 }}
                      className="absolute inset-0 bg-slate-950 p-4 z-40 flex flex-col justify-between border-t border-slate-800 text-white"
                    >
        ...
        {/* SECTION 2: EL PROBLEMA vs. LA SOLUCIÓN (Bento Grid) */}
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-slate-100">
          ...
          <motion.div 
            whileHover={{ y: -6 }}
            transition={springTransition}
            className="bg-[#FFFFFF] border border-slate-200/80 rounded-3xl p-8 shadow-sm flex flex-col justify-between relative overflow-hidden group hover:border-red-500/40 hover:shadow-lg hover:shadow-red-500/5 transition-all duration-300"
          >
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-extrabold text-[#0F172A]">El Problema de las PYMEs</h3>
          ...
          {/* Card B: La Solución S&M */}
          <motion.div 
            whileHover={{ y: -6 }}
            transition={springTransition}
            className="bg-[#FFFFFF] border border-slate-200/80 rounded-3xl p-8 shadow-sm flex flex-col justify-between relative overflow-hidden group hover:border-[#10B981]/50 hover:shadow-lg hover:shadow-emerald-500/5 transition-all duration-300"
          >
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-extrabold text-[#0F172A]">La Solución S&M</h3>
                <p className="text-xs text-slate-500 leading-relaxed font-medium">
        ...
        {/* SECTION 3: SERVICIOS (3-Card Interactive Bento Grid) */}
        <section id="servicios" className="space-y-8 pt-6 border-t border-slate-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div 
              whileHover={{ y: -6 }}
              transition={springTransition}
              className="bg-white border border-slate-200/80 rounded-3xl p-8 shadow-sm flex flex-col justify-between min-h-[360px] relative overflow-hidden group hover:border-[#10B981]/50 hover:shadow-lg hover:shadow-emerald-500/5 transition-all duration-300"
            >
              <div className="space-y-6">
                <div className="w-12 h-12 rounded-2xl bg-emerald-50 text-[#10B981] flex items-center justify-center border border-emerald-100 group-hover:scale-110 transition-transform duration-300 shadow-sm">
            ...
            <motion.div 
              whileHover={{ y: -6 }}
              transition={springTransition}
              className="bg-white border border-slate-200/80 rounded-3xl p-8 shadow-sm flex flex-col justify-between min-h-[360px] relative overflow-hidden group hover:border-[#06B6D4]/50 hover:shadow-lg hover:shadow-cyan-500/5 transition-all duration-300"
            >
              <div className="space-y-6">
                <div className="w-12 h-12 rounded-2xl bg-cyan-50 text-[#06B6D4] flex items-center justify-center border border-cyan-100 group-hover:scale-110 transition-transform duration-300 shadow-sm">
            ...
            <motion.div 
              whileHover={{ y: -6 }}
              transition={springTransition}
              className="bg-white border border-slate-200/80 rounded-3xl p-8 shadow-sm flex flex-col justify-between min-h-[360px] relative overflow-hidden group hover:border-slate-800/40 hover:shadow-lg hover:shadow-slate-800/5 transition-all duration-300"
            >
              <div className="space-y-6">
                <div className="w-12 h-12 rounded-2xl bg-slate-100 text-slate-800 flex items-center justify-center border border-slate-200 group-hover:scale-110 transition-transform duration-300 shadow-sm">
              ...
              <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                <span className="text-[9px] font-extrabold uppercase tracking-wider text-slate-700">Automatización de Ventas</span>
                <ChevronRight className="w-4 h-4 text-slate-400 group-hover:translate-x-1.5 transition-transform" />
              </div>
            </motion.div>
        ...
        {/* SECTION 4: CÓMO TRABAJAMOS (Animated Pipeline Workflow) */}
        <section id="proceso" className="space-y-8 border-t border-slate-200/80 pt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto relative">
            ...
            <motion.div 
              ...
              transition={springTransition}
              whileHover={{ y: -6 }}
              className="bg-slate-50 border border-slate-200/60 rounded-3xl p-8 relative flex flex-col justify-between shadow-sm group hover:border-[#10B981]/50 transition-all duration-300"
            >
              <div className="space-y-4">
                ...
                <h4 className="font-extrabold text-lg text-[#0F172A]">01. Conexión</h4>
                <p className="text-xs text-slate-500 leading-relaxed font-medium">
            ...
            >
              <div className="space-y-4">
                ...
                <h4 className="font-extrabold text-lg text-[#0F172A]">02. Creación</h4>
                <p className="text-xs text-slate-500 leading-relaxed font-medium">
            ...
            <motion.div 
              ...
              whileHover={{ y: -6 }}
              className="bg-slate-50 border border-slate-200/60 rounded-3xl p-8 relative flex flex-col justify-between shadow-sm group hover:border-[#06B6D4]/50 transition-all duration-300"
            >
              <div className="space-y-4">
                ...
                <h4 className="font-extrabold text-lg text-[#0F172A]">03. Lanzamiento</h4>
                <p className="text-xs text-slate-500 leading-relaxed font-medium">
        ...
        {/* SECTION 5: QUIÉNES SOMOS (The Core Team Bento) */}
        <section id="nosotros" className="space-y-8 border-t border-slate-200/80 pt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <motion.div 
              whileHover={{ y: -6 }}
              transition={springTransition}
              className="bg-[#0F172A] text-white border border-slate-800 rounded-3xl p-8 flex flex-col sm:flex-row items-start gap-6 shadow-xl relative overflow-hidden group hover:border-[#10B981]/50 transition-all duration-300"
            >
            ...
            <motion.div 
              whileHover={{ y: -6 }}
              transition={springTransition}
              className="bg-[#0F172A] text-white border border-slate-800 rounded-3xl p-8 flex flex-col sm:flex-row items-start gap-6 shadow-xl relative overflow-hidden group hover:border-[#06B6D4]/50 transition-all duration-300"
            >
              <div className="absolute inset-0 bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)] bg-[size:1.5rem_1.5rem] opacity-30 pointer-events-none" />
        ...
        <section id="contacto" className="max-w-3xl mx-auto">
          <motion.div 
            ...
            transition={springTransition}
            className="bg-[#0F172A] text-white border border-slate-800 rounded-3xl p-8 lg:p-12 shadow-2xl relative overflow-hidden group hover:border-cyan-500/40 transition-all duration-300"
          >
