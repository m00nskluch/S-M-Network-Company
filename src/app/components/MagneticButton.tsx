...
export function MagneticButton({
  ...
  const primaryStyle = [
    'glass-cta-btn',
    'font-medium',
    'border border-[rgba(132,182,244,0.5)]',
    'shadow-[0_4px_18px_rgba(132,182,244,0.30)]',
    'hover:shadow-[0_8px_32px_rgba(132,182,244,0.42)]',
    'hover:bg-[#5F90C5]',
    'active:bg-[#5483B8]',
  ].join(' ');
  ...
  const secondaryStyle = [
    ...
    'font-medium',
    'hover:border-[rgba(132,182,244,0.55)]',
    'hover:shadow-[0_4px_16px_rgba(132,182,244,0.14)]',
  ].join(' ');
