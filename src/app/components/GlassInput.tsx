...
export function GlassInput({
  ...
  const glowShadow = error
    ...
    : focused
    ? '0 0 0 3.5px rgba(132,182,244,0.22), 0 4px 16px rgba(132,182,244,0.14)'
    : '0 2px 8px rgba(132,182,244,0.08)';
        ...
        {!prefersReduced && focused && (
          <div
            ...
            style={{
              left: 0,
              right: 0,
              background: `radial-gradient(200px circle at ${glowX}% 50%, rgba(132,182,244,0.60), transparent 70%)`,
              opacity: focused ? 1 : 0,
